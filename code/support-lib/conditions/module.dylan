...
define module conditions
   ...
   export
      ...
      duplicate-configs-in-cfg-files,
      ...
      error-in-config,
      error-in-config-option,
      file-error,
      file-not-found,
      file-type-not-known,
      footnote-referenced-outside-topic,
      id-matches-topic-title,
      illegal-character-in-id,
      illegal-character-in-section-style,
      ...
      no-target-for-indexed-reference,
